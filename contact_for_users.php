     ...
     $db   = $obj->connect[3];
       ...
       $conn= new mysqli($host,$user,$pass,$db);
        ...
        if($conn->connect_error)
         ...
         $sql="select id,name,email,message,created from contact";
         $result=$conn->query($sql);
       
        echo "<table id=table1>
           <form action='contact_for_users_delete.php' method='post' onSubmit='return delete_confirm();'/> 
                  <tr> 
                  <td id=hr1> Sent </td>
                  <td id=hr1> Name </td> 
                  <td id=hr1> Email </td>
                  ...
                  <input type='submit'  id='del-submit' name='delete_contact' value='Delete'/>           
                </td>
                    </tr>";
        ...
        echo " 
               ...
               <td> <a href='#top' id='a2'> Back to Top </a> </td> 
                  <td>  </td> <td> </td> <td> </td>
               <td><a href='contact_for_users_export.php' id=a2> Export as pdf </a>  </td> 
                  </tr>";     
            echo "</table>";

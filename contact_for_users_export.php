...
$pdf->Cell(202,12,"All contacts for users",1,0,'C',TRUE);
$pdf->Ln(); // afhnei mia grammh keno kai paei apo katw
$pdf->Cell(35,15,"Created",1,0,'C',TRUE); // edw vazeis platos,upsos,onoma,border w,0h,kai true gia na parei to xrwma
$pdf->Cell(22,15,"From",1,0,'C',TRUE);
$pdf->Cell(60,15,"To",1,0,'C',TRUE);
$pdf->Cell(85,15,"Message",1,0,'C',TRUE);
$pdf->Ln();


        $sql="select created,name,email,message from contact";
        ...
        while($row=$result->fetch_assoc())
        {
            ...
            $pdf->Cell(35,7,$created,1);
            //$pdf->Cell(10,7,$blank);
            $pdf->Cell(22,7,$name,1);
            $pdf->Cell(60,7,$email,1);
            $pdf->Cell(85,7,$message,1); // edw emfanizei olo to keimeno kanwntas ansiplwsh keimenou
           $pdf->Ln(); 
        }
